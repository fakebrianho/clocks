...
function init() {
	...
	;(async function () {
		...
		meshes.middleRing = ring(texture, 0.11, true)
		meshes.middleRing.scale.set(0.55, 0.55)
		meshes.outerRing = ring(texture, 0.24, false)
		meshes.outerRing.scale.set(1.2, 1.2)
		/*------------------------------
		2 * 1.2 = 2.4; 2 * 0.55 = 1.10; 2 * 0.2 = 0.4;
		1.2 * 0.15 = 0.18; 0.55 * 0.35 = 0.1925; 0.2 x 0.5= 0.1
		------------------------------*/
		/*------------------------------
		Block
		------------------------------*/
		innerGroup.add(meshes.innerRing)
		innerGroup.position.set(1.72, 0, 0)
