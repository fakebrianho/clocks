...
import { addMouseFunctions } from './mouse'
import {
...
function animate() {
	...
	if (!PARAMS.Simulate) {
		...
		middleGroup.rotation.z -= 0.00024
		innerGroup.rotation.z -= 0.0029
		trigger = true
	}
	middleGroup.rotation.x = middleGroup.rotation.x * 0.95 + m.x * 1.2 * 0.05
	middleGroup.rotation.y = middleGroup.rotation.y * 0.95 + m.y * 1.2 * 0.05
